...
const base = `kinue@<span style="color: #b8d5ef">mahiro.software</span>:<span style="color: dodgerblue">~</span>$ `;
let array = [];
let input = "";
let lastIdx = -1;
let lastCmd = "";
...
function inputLine(k) {
    terminal.innerHTML += `\n<div class=\"new-line\">kinue@<span style=\"color: #b8d5ef\">mahiro.software</span>:<span style=\"color: dodgerblue\">~</span>$ ${k ? k : ""}</div>`
}
...
function info() {
    terminal.innerHTML += '\n<img alt="icon" class="img" src="static/icon.png">\n' + "  <div><span>kinue</span>@<span>mahiro.software</span></div>\n" + "  <div>---------------------</div>\n" + "  <div><span>OS</span>: Bloatdoze</div>\n" + "  <div><span>Ages</span>: Skid</div>\n" + "  <div><span>Twitter</span>: <a href=\"https://bit.ly/3nMdQZz\" target='_blank'>@kinue72</a></div>\n" + "  <div><span>Discord</span>: <a href=\"https://discord.com\" target='_blank'>Kinue#9999</a></div>\n" + "  <div><span>Youtube</span>: <a href=\"https://bit.ly/3nMdQZz\" target='_blank'>Mahiro Software</a></div>\n" + "  <div><span>Github</span>: <a href=\"https://github.com/Kinue72\" target='_blank'>Kinue72</a></div>\n" + "  <div><span>osu!</span>: <a href=\"https://osu.ppy.sh/users/13473479\" target='_blank'>IntelliJ Idea</a></div>\n" + "  <div><span>Mahiro Client v1</span>: <a href=\"https://bit.ly/3nMdQZz\" target='_blank'>Cheat now!</a></div>\n" + '  <div style="padding-bottom:10px; clear: both;">'
}
